...
public class Demo17_SleepVsJoinFailureTest {

    @Test
    void demo17_runs_and_prints_summary() throws Exception {
        System.setProperty("demo.runs", "5");
        System.setProperty("demo.sleepMs", "0"); // make failure very likely + fast

        String out = TestIO.captureOut(() -> Demo17_SleepVsJoinFailure.main(new String[0]));
