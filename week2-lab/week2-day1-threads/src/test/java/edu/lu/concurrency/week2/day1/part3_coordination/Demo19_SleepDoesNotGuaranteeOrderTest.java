...
public class Demo19_SleepDoesNotGuaranteeOrderTest {

    @Test
    void demo19_runs_and_prints_summary() throws Exception {
        System.setProperty("demo.runs", "10");
        System.setProperty("demo.sleepMs", "0");

        String out = TestIO.captureOut(() -> Demo19_SleepDoesNotGuaranteeOrder.main(new String[0]));
