...
public class Demo20_HappensBeforeJoinTest {

    @Test
    void demo20_runs_and_mentions_happens_before_or_visibility() throws Exception {
        System.setProperty("demo.runs", "10");

        String out = TestIO.captureOut(() -> Demo20_HappensBeforeJoin.main(new String[0]));
