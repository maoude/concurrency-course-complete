...
public class Demo28_JoinDoesNotFixRaceTest {

    @Test
    void demo28_runs_and_mentions_join_not_fix() throws Exception {
        String out = TestIO.captureStdout(() -> Demo28_JoinDoesNotFixRace.main(new String[0]));
