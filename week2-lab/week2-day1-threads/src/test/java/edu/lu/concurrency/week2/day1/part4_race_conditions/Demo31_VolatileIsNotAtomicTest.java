...
public class Demo31_VolatileIsNotAtomicTest {

    @Test
    void demo31_runs_and_mentions_volatile_not_atomic() throws Exception {
        String out = TestIO.captureStdout(() -> Demo31_VolatileIsNotAtomic.main(new String[0]));
