...
public class Demo09_BlockedVsWaitingTest {

    @Test
    void demo09_reports_both_states() throws Exception {
        String out = TestIO.captureStdout(() -> Demo09_BlockedVsWaiting.main(new String[0]));
