...
5. Complete `CONCURRENCY_SCORECARD.md`.
6. Use `..\..\MEASUREMENT_TEMPLATE.md` for the throughput observation.
7. Finish with `.\gradlew.bat clean test`.
...
- which Release 2 pitfall from `PITFALLS.md` applies
...
Use `..\..\CHECKPOINT2_RUBRIC.md` to prepare the checkpoint evidence.
