...
public final class Sol5_RequestContext {
    // ThreadLocal stores a separate request id per worker thread.
    ...
    public static void set(String requestId) {
        // Objects.requireNonNull fails fast instead of storing an ambiguous null context.
        REQUEST_ID.set(Objects.requireNonNull(requestId, "requestId"));
    }

    public static String get() {
        // get() returns only the current thread's request id.
        return REQUEST_ID.get();
    }

    public static void clear() {
        // remove() is stronger than set(null): it clears the ThreadLocal entry for this worker.
        REQUEST_ID.remove();
    }
    ...
    public static void runWithContext(String requestId, Runnable task) {
        ...
        try {
            ...
            // This prevents request context leaks when executor workers are reused.
            clear();
        }
    }
}
